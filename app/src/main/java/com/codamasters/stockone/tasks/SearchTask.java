                        ...
                        CustomRequest jsObjRequest = new CustomRequest(Request.Method.GET, URL_BASE, params, new Response.Listener<JSONObject>() {
                            ...
                            public void onResponse(JSONObject response) {
                                try {
                                    ...
                                    aux_stock.setCurrent(Float.valueOf(response.getJSONObject("query").getJSONObject("results").getJSONObject("quote").get("LastTradePriceOnly").toString()));
                                    ...
                                    aux_stock.setVolume(Long.valueOf(response.getJSONObject("query").getJSONObject("results").getJSONObject("quote").get("Volume").toString()));
                                    aux_stock.setPercentage(response.getJSONObject("query").getJSONObject("results").getJSONObject("quote").get("PercentChange").toString());
